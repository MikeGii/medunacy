...
export default function RegisterModal({ onSwitchToLogin, onClose }: RegisterModalProps) {
  ...
  // Enhanced success countdown timer
  useEffect(() => {
    if (message?.type === 'success' && countdown === null) {
