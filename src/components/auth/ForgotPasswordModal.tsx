...
export default function ForgotPasswordModal({ onBackToLogin, onClose }: ForgotPasswordModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setMessage({
        type: 'error',
        text: errorMessage.includes('User not found') ? t('messages.user_not_found') : t('messages.error')
      });
    } finally {
      setLoading(false);
    }
