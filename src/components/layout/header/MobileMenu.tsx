  ...
  return (
   ...
   border border-[#118B50]/10 hover:border-[#5DB996]/20"
            ...
            <Link
              ...
              onClick={onClose}
              className="flex items-center space-x-3 w-full px-6 py-3 text-yellow-600 hover:text-yellow-700 
   bg-gradient-to-r from-yellow-50/20 to-amber-50/20 hover:from-yellow-50/30 hover:to-amber-50/30 
   rounded-full transition-all duration-300 border border-yellow-400/20"
            >
