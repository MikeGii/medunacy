            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p className="text-sm text-gray-600 mb-1">{tProfile("first_name")}</p>
                  <p className="font-medium text-gray-800">{user.first_name || "-"}</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p className="text-sm text-gray-600 mb-1">{tProfile("last_name")}</p>
                  <p className="font-medium text-gray-800">{user.last_name || "-"}</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p className="text-sm text-gray-600 mb-1">{tProfile("email")}</p>
                  <p className="font-medium text-gray-800">{user.email}</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p className="text-sm text-gray-600 mb-1">{tProfile("phone")}</p>
            ...
            {loading ? (
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <p className="text-sm text-gray-600 mb-1">{tProfile("university")}</p>
                    <p className="font-medium text-gray-800">
                      {profileData.university || "-"}
                      {profileData.university_finished && (
                        <span className="ml-2 text-sm text-green-600">({tProfile("university_finished")})</span>
                      )}
                    </p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <p className="text-sm text-gray-600 mb-1">{tProfile("specialization")}</p>
                    <p className="font-medium text-gray-800">{profileData.specialization || "-"}</p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <p className="text-sm text-gray-600 mb-1">{tProfile("workplace")}</p>
                    <p className="font-medium text-gray-800">{profileData.workplace || "-"}</p>
                  </div>
                  {profileData.languages && profileData.languages.length > 0 && (
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <p className="text-sm text-gray-600 mb-2">{tProfile("languages")}</p>
                  ...
                  {profileData.personal_description && (
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <p className="text-sm text-gray-600 mb-1">{tProfile("personal_description")}</p>
                      <p className="font-medium text-gray-800 whitespace-pre-wrap">{profileData.personal_description}</p>
                    </div>
                  )}
                </div>
              </div>
