          ...
          {adminActions.map((action, index) => (
            ...
            >
              ...
              >
                ...
                <div className="relative flex items-center space-x-4 md:space-x-6">
                  ...
                  <div className="flex-shrink-0">
                    <div className="w-8 h-8 md:w-10 md:h-10 bg-gradient-to-r from-yellow-500 to-amber-600 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                      <svg
                        className="w-4 h-4 md:w-5 md:h-5 text-white group-hover:translate-x-1 transition-transform duration-300"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
                ...
                <div
                  className="absolute bottom-0 left-6 right-6 h-1 bg-gradient-to-r from-yellow-500 to-amber-600 rounded-full 
